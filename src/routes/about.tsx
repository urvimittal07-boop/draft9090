...
import mosaicMusic from "@/assets/mosaic-music.jpg";
import mosaicFood from "@/assets/mosaic-food.jpg";
import mosaicPoetry from "@/assets/mosaic-poetry.jpg";
import mosaicHosting from "@/assets/mosaic-hosting.jpg";
...
const MOSAIC = [
  ...
  { label: "Music", note: "upbeat R&B to qawwali nights", img: mosaicMusic, span: "col-span-2 row-span-1", rot: -1, tape: "tape" },
  { label: "Dogs", note: "every single one, even the grumpy ones", color: "bg-card border border-ink/15", span: "col-span-1 row-span-1", rot: 2 },
  { label: "Debating", note: "i will win (politely)", img: mosaicLoves, span: "col-span-1 row-span-1", rot: -2, tape: "tape-pink" },
  { label: "Dancing", note: "trained bharatnatyam → hip-hop", img: mosaicLoves, span: "col-span-2 row-span-2", rot: -1, tape: "tape" },
  ...
  { label: "Sketching", note: "margins of every notebook", img: mosaicPoetry, span: "col-span-2 row-span-2", rot: 2, tape: "tape-pink" },
  { label: "Running", note: "morning miles, messy thoughts", img: mosaicLoves, span: "col-span-2 row-span-1", rot: 3, tape: "tape" },
  { label: "Sewing", note: "stitching my own fits", color: "bg-cream", span: "col-span-1 row-span-1", rot: 2 },
  { label: "Styling", note: "weird from scratch, quirky on purpose", img: mosaicLoves, span: "col-span-2 row-span-2", rot: 1, tape: "tape-pink" },
  ...
  { label: "Poetry", note: "midnight notes app confessions", color: "bg-orange/80 text-paper", span: "col-span-1 row-span-1", rot: -3 },
  { label: "Food", note: "tasting menu of life, especially tiramisu", img: mosaicFood, span: "col-span-2 row-span-2", rot: 3, tape: "tape-pink" },
  { label: "Culture", note: "inspired by cultures all over the world", img: mosaicLoves, span: "col-span-2 row-span-1", rot: 1, tape: "tape" },
  ...
  { label: "Social groups", note: "rooms full of people, my kind of chaos", color: "bg-card border border-ink/15", span: "col-span-1 row-span-1", rot: -2 },
  { label: "Hosting", note: "a table, candles, controlled chaos", img: mosaicHosting, span: "col-span-2 row-span-2", rot: 1, tape: "tape-pink" },
];
